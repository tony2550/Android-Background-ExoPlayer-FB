...
public class MediaSeekBar extends AppCompatSeekBar {
    ...
    public MediaSeekBar(@NonNull @NotNull Context context) {
        super(context);
    }

    public MediaSeekBar(@NonNull @NotNull Context context, @Nullable @org.jetbrains.annotations.Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MediaSeekBar(@NonNull @NotNull Context context, @Nullable @org.jetbrains.annotations.Nullable AttributeSet attrs, int defStyleAttr) {
